...
def main():
    ...
    train_feat3, train_labels3, val_feat3, val_labels3, test_feat3, test_labels3 = gen_data(data3, labels3, silly = True)
    ...
    train_feat6, train_labels6, val_feat6, val_labels6, test_feat6, test_labels6 = gen_data(data6, labels6, silly = True)
    ...
    train_feat12, train_labels12, val_feat12, val_labels12, test_feat12, test_labels12 = gen_data(data12, labels12, silly = True)
    ...
    train_feat18, train_labels18, val_feat18, val_labels18, test_feat18, test_labels18 = gen_data(data18, labels18, silly = True)
    ...
    train_feat24, train_labels24, val_feat24, val_labels24, test_feat24, test_labels24 = gen_data(data24, labels24, silly = True)
    ...
    train_feat36, train_labels36, val_feat36, val_labels36, test_feat36, test_labels36 = gen_data(data36, labels36, silly = True)
